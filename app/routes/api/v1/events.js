...
module.exports = function(app) {
    ...
    app.namespace('/api/v1', function () {
        ...
        app.put('/events/:id', authorization.requiresLogin, hasAuthorization, events.update);
        app.del('/events/:id', authorization.requiresLogin, hasAuthorization, events.destroy);
